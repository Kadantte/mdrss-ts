	...
	<div class="mx-auto max-w-3xl p-4 mb-4 flex flex-col gap-4">
		...
		<div class="flex flex-col gap-2">
			...
			<ul class="list-disc ml-5">
				...
				<li>
					Specify two tags (inclusive) and two tags (exclusive): The manga of
					the result chapters will have all inclusive tags, and will not have
					any of the exclusive tags.
				</li>
			</ul>
		</div>
	</div>
